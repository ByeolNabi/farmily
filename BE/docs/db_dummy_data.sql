...
INSERT INTO ref_plant_disease (id, name, symptom, duration, causation, instruction) VALUES
(1, '흰가루병', '잎에 흰 가루 같은 곰팡이가 생기며 잎이 노랗게 변함', 21, '과습 환경, 통풍 부족', '감염된 잎 제거, 통풍 개선, 살균제 분무'),
(2, '잎마름병', '잎 끝부터 갈색으로 마르며 점점 퍼져나감', 14, '과습 또는 건조 스트레스', '과습 방지, 감염 부위 제거, 물빠짐 개선'),
(3, '점무늬병', '잎에 갈색 또는 검은색 점이 생김', 18, '습한 환경, 물이 잎에 닿음', '환기 자주 시키기, 잎에 물 닿지 않게 주의'),
(4, '응애', '잎 뒷면에 아주 작은 거미줄이 생기고 잎이 변색됨', 10, '건조한 환경, 통풍 부족', '잎 뒷면 세척, 습도 높이기, 전용 약제 사용'),
(5, '진딧물', '줄기나 잎에 작은 벌레가 붙어 즙액을 빨아먹음', 10, '봄철 온도 상승, 과밀 재배', '천연 살충제 사용, 흐르는 물에 씻어내기'),
(6, '무름병', '줄기나 뿌리 조직이 흐물흐물해지고 악취가 남', 5, '과습, 배수 불량', '즉시 배수 개선, 감염 부위 제거 후 소독'),
(7, '깍지벌레', '솜뭉치 같은 흰색 벌레가 붙어 있음', 21, '통풍 부족, 감염된 식물 접촉', '핀셋으로 제거, 알코올 묻힌 솜으로 닦기'),
(8, '과습 스트레스', '잎이 노랗게 변하고 축 늘어짐', 10, '과도한 물주기, 배수 불량', '물주기 중단, 흙 말리기, 분갈이 고려'),
(9, '비료 과다', '잎 끝이 타는 듯이 갈색으로 변함', 14, '과도한 비료 사용', '흙을 물로 씻어내거나 분갈이'),
(10, '햇빛 부족', '줄기가 웃자라고 잎 사이 간격이 넓어짐', 30, '빛 부족 환경', '서서히 밝은 곳으로 이동');
